...
declare -A PORTS=([api]=49420 [vite]=45173 [docusaurus]=48888)
declare -A DIRS=([api]=/workspace [vite]=/workspace/ui [docusaurus]=/workspace/website)
declare -A CMDS=(
  [api]="/usr/local/go/bin/go run ./cmd/skillshare ui --no-open --host 0.0.0.0 --port 49420"
  [vite]="${PNPM_BIN:-pnpm} exec vite --host 0.0.0.0 --port 45173 --strictPort"
  [docusaurus]="${PNPM_BIN:-pnpm} exec docusaurus start --host 0.0.0.0 --port 48888 --no-open"
)
