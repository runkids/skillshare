...
it('removes from source without syncing when an Agent entry conflicts', async () => {
  ...
  render(<QueryClientProvider client={new QueryClient()}><I18nProvider><MCPRemoveDialog name="docs" targets={['cursor', 'claude']} onClose={vi.fn()} onSaved={saved} /></I18nProvider></QueryClientProvider>);
